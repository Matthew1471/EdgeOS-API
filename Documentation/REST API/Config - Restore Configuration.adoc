...
This method is CSRF protected so also requires a `X-CSRF-TOKEN` (see link:../README.adoc#Sensitive_Requests_(CSRF_Protection)[Sensitive Requests (CSRF Protection)]).
